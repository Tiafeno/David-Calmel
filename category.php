...
<div id="primary"  class="uk-container  uk-container-large uk-padding-remove-left uk-padding-remove-right">
      ...
      <div class="uk-container uk-container-small uk-navbar">
        <div class="uk-navbar-left">
          <ul class="uk-navbar-nav category-title">
              <li class="uk-active"><a href="#"><h2><?= single_cat_title() ?></h2></a></li>
          </ul>
        </div>
        ...
        <?php
        $parent_terms = get_terms('category', array('name' => get_Title(), 'hide_empty' => false ) );
        $ctgs = array();
        foreach ( $parent_terms as $pterm ) {
          ...
          foreach ( $terms as $term ) {
            ...
            if(single_term_title("", false) == $term->name) continue;
        ?>
  ...
  <?php if ( have_posts() ) : ?>
     ...
     */
      get_template_part( 'tpls/content','category' );
    endwhile;
  ?> </div> <?php
  else :
